...
final class FunctionalProtectedAreaEntityProviderGuardTest extends FunctionalProtectedAreaEntityProviderTest
{
    protected bool $newSecuritySystem = false;

    protected static array $kernelOptions = [
        'security' => 'security_guard_entity_provider.yaml'
    ];
